...
class LLMAdvancedPlayground extends PlaygroundType{
    static identifier = "llmadvanced"
    constructor() {
        super(false);
    }
        ...
        return `
            ...
            <div class="playground-section">
                ...
                <div class="playground-input">
                    <textarea id="sys-input" name="text-input" rows="4" cols="50" placeholder="System prompt here"></textarea>
                </div>
                <div class="playground-input">
    ...
    onRunTrigger() {
        ...
        this.makeRequest("/ai/generate","POST",{
            ...
            system_prompt:this.getInput("sys-input")+SAFETY_SYS_PROMPT
            ,
        }).then(data=>{
            console.log(data)
            this.hideSpinner()
